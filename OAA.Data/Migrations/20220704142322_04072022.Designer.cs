...
namespace SC.Data.Migrations
{
    ...
    [Migration("20220704142322_04072022")]
    partial class _04072022
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SC.Data.Deliverycategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SC.Data.DeliveryItem", b =>
                {
                    ...
                    b.Property<string>("DropOf_contact");

                    b.Property<string>("DropOf_email");
                    ...
                    b.Property<string>("PickUp_contact");
            ...
            modelBuilder.Entity("SC.Data.DeliveryPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SC.Data.Deliverycategory", b =>
                {
                    ...
                    b.HasOne("SC.Data.Deliverycategory", "Maincategory")
                        .WithMany()
            ...
            modelBuilder.Entity("SC.Data.DeliveryItem", b =>
                {
                    ...
                    b.HasOne("SC.Data.Deliverycategory", "Deliverycategory")
                        .WithMany()
            ...
            modelBuilder.Entity("SC.Data.DeliveryPayment", b =>
                {
                    ...
                    b.HasOne("SC.Data.DeliveryItem", "DeliveryItem")
                        .WithMany()
